        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CodeDepositTypeNavigationDepositType1 = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Deposits", x => x.DepositId);
                    table.ForeignKey(
                        name: "FK_Deposits_DepositType_CodeDepositTypeNavigationDepositType1",
                        column: x => x.CodeDepositTypeNavigationDepositType1,
                        principalTable: "DepositType",
                        principalColumn: "DepositType1",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Deposits_CodeDepositTypeNavigationDepositType1",
                table: "Deposits",
                column: "CodeDepositTypeNavigationDepositType1");
